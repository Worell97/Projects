...
uses
  ...
  DAO_Pessoa in 'src\Model\DAO\DAO_Pessoa.pas',
  DTO_Pessoa in 'src\Model\DTO\DTO_Pessoa.pas',
  DTO_Endereco in 'src\Model\DTO\DTO_Endereco.pas',
  DTO_Endereco_Integracao in 'src\Model\DTO\DTO_Endereco_Integracao.pas',
  DAO_Endereco in 'src\Model\DAO\DAO_Endereco.pas',
  DAO_Endereco_Integracao in 'src\Model\DAO\DAO_Endereco_Integracao.pas',
  ThreadAtualizaEnderecos in 'ThreadAtualizaEnderecos.pas',
  JsonObjectIntegracao in 'src\Model\JsonObjectIntegracao.pas';
